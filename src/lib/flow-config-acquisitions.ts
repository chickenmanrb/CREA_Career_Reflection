...
const AGENT_1 = process.env.NEXT_PUBLIC_ELEVENLABS_AGENT_ID ?? "agent_9301kb17m8qafjz81fzh3xed32gw";
const AGENT_2 = process.env.NEXT_PUBLIC_ELEVENLABS_AGENT_2_ID ?? "agent_3001kb17yts2ez6tmp7h6yczfeej";
const AGENT_3 = process.env.NEXT_PUBLIC_ELEVENLABS_AGENT_3_ID ?? "agent_4101kb18epgrfpd8fthhywkwc5vh";
const AGENT_4 = process.env.NEXT_PUBLIC_ELEVENLABS_AGENT_4_ID ?? "agent_2101kb18g7gtesyv4319ybbppf6y";
const AGENT_5 = process.env.NEXT_PUBLIC_ELEVENLABS_AGENT_5_ID ?? "agent_4301kb18hc1mfvz9qwrw5k5acnry";
const AGENT_6 = process.env.NEXT_PUBLIC_ELEVENLABS_AGENT_6_ID ?? "agent_7001kb18jpckevg876ah1m4472hc";

export const acquisitionsFlowConfig: MultiAgentConfig = {
  steps: [
    {
      id: "intro",
      type: "intro",
