...
export const REFLECTION_MODULES: Record<ReflectionModuleId, ReflectionModule> = {
  ...
  brokerage: {
    id: "brokerage",
    slug: "capital-markets-brokerage",
    exercise: "brokerage",
    storagePrefix: "brokerage",
    title: "Capital Markets Brokerage Career Pathway Reflection",
    transcriptTitle: "Capital Markets Brokerage Career Pathway Reflection Transcript",
  ...
  lending: {
    ...
    slug: "lending",
    exercise: "lending",
    storagePrefix: "lending",
    title: "Lending Career Pathway Reflection",
    transcriptTitle: "Lending Career Pathway Reflection Transcript",
    transcriptFilenamePrefix: "lending-reflection-transcript",
