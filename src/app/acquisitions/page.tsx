...
export default function AcquisitionsEntryPage() {
  ...
  const handleStart = (e: React.MouseEvent | React.FormEvent) => {
    ...
    router.push("/acquisitions/interview");
  };
            ...
            <div className="rounded-xl border bg-white p-4 shadow-sm">
              ...
              <form className="mt-3 space-y-3" onSubmit={handleStart}>
                <div className="space-y-1">
                  ...
                  />
                  {!isNameValid && <p className="text-[11px] text-amber-600">Please enter your name.</p>}
                </div>
                <div className="space-y-1">
                  ...
                  />
                  {!isEmailValid && <p className="text-[11px] text-amber-600">Enter a valid email.</p>}
                </div>
                <button
                  type="submit"
